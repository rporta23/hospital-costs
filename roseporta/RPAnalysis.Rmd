...
pred <- predict(tree_train, newdata = test_data )
...
compute_MSEP_regtree <- function(train_data, formula, i){
  ...
  tree_train <- tree(formula, 
             current_train_folds, 
             control = tree.control(nrow(train_data), 
                                    mincut = 2,
                                    minsize = 4,
                                    mindev = 0.01
                                    )
  ...
  pred <- predict(tree_train, newdata = current_test_fold )
