...
```
Best number of terminal nodes is 8 but that is too large when using individual folds for cross validation error rates. 
...
compute_MSEP_regression_tree <- function(train_data,i){
    ...
    prune.costs = prune.tree(tree.costs,best = 7)
