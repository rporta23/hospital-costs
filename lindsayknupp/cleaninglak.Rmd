...
ggplot(df1) + 
  geom_point(aes(x=days,y=`Total Assets`))
...
hpc_clean <- hpc |> 
  janitor::clean_names() |> 
  select(provider_ccn,total_costs, rural_versus_urban, provider_type, type_of_control,
