...
logit_model = glm("costs_bin ~ fte_employees_on_payroll * total_income + provider_bin_Specialized*fte_employees_on_payroll",data = select(train,-fold),family = binomial)
